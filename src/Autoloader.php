...
class Autoloader {
	...
	public static function autoload(): bool {
		...
		if ( defined( 'WPD_CONFIGUR_AUTOLOAD' ) && false === WPD_CONFIGUR_AUTOLOAD ) {
			return true;
		}
	...
	protected static function missing_autoloader_notice(): void {
		$error_message = __( 'WPDecoupled Configure: The Composer autoloader was not found. If you installed the plugin from the GitHub source, make sure to run `composer install`.', 'wp-decoupled-configur' );
